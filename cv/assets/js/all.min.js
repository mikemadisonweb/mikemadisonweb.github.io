...
!function(e){"use strict";e(document).ready(function(){"undefined"!=typeof e.fn.simplePlaceholder&&e("input[placeholder], textarea[placeholder]").simplePlaceholder(),"undefined"!=typeof e.fn.fitVids&&e(".fitvids").fitVids(),"undefined"!=typeof e.fn.bxSlider&&e(".bxslider .slides").bxSlider({mode:"fade",speed:500,infiniteLoop:!0,hideControlOnEnd:!1,pager:!0,pagerType:"full",controls:!0,auto:!0,pause:4e3,autoHover:!0,useCSS:!1}),"undefined"!=typeof e.fn.magnificPopup&&(e(".magnificPopup").magnificPopup({disableOn:400,closeOnContentClick:!0,type:"image"}),e(".magnificPopup-gallery").magnificPopup({disableOn:400,type:"image",gallery:{enabled:!0}})),"undefined"!=typeof e.fn.easytabs&&(e(".tabs-container").easytabs({animationSpeed:300,updateHash:!1}),e(".vertical-tabs-container").easytabs({animationSpeed:300,updateHash:!1})),"undefined"!=typeof e.fn.gMap&&e(".google-map").each(function(){var i=e(this),t=parseInt(i.attr("data-zoom")),a=i.attr("data-address"),o=i.attr("data-caption");i.gMap({maptype:"ROADMAP",scrollwheel:!1,zoom:t,markers:[{address:a,html:o,popup:!1}]})}),"undefined"!=typeof e.fn.isotope&&e(window).width()>767&&e(".portfolio-items").imagesLoaded(function(){var i=e(".portfolio-items");i.isotope({itemSelector:".item",layoutMode:"masonry"}),e(".portfolio-filter li a").click(function(){e(".portfolio-filter li a").removeClass("active"),e(this).addClass("active");var t=e(this).attr("data-filter");return i.isotope({filter:t}),!1}),e(window).resize(function(){i.isotope({})})})}),e(window).scroll(function(){})}(window.jQuery);
!function(t){"use strict";function e(){var t=document.createElement("style");t.appendChild(document.createTextNode("@-ms-viewport { width: device-width; }")),navigator.userAgent.match(/IEMobile\/10\.0/)&&t.appendChild(document.createTextNode("@-ms-viewport { width: auto !important; }")),document.getElementsByTagName("head")[0].appendChild(t)}function n(){t(".pie-chart").each(function(){var e=t(this),n=e.parent().width(),a=e.attr("data-barSize");n<a&&(a=n),e.css("height",a),e.css("width",a),e.css("line-height",a+"px"),e.find("i").css({"line-height":a+"px","font-size":a/3})})}function a(){"undefined"!=typeof t.fn.parallax&&t(".parallax").each(function(){var e=t(this);e.addClass("parallax-enabled"),e.parallax("49%",.3,!1)})}function i(){t("#back-to-top").click(function(){return t("html, body").animate({scrollTop:0},"slow"),!1})}function c(){t(window).scrollTop()>t(window).height()/2?(t("#back-to-top").removeClass("gone"),t("#back-to-top").addClass("visible")):(t("#back-to-top").removeClass("visible"),t("#back-to-top").addClass("gone"))}function o(){t(window).width()>767&&(t(".cv-contact").animate({left:"-320px"}),t(".cv-contact .cv-contact-toggle").click(function(e){e.preventDefault();var n=t(".cv-contact");"-320px"===n.css("left")?t(".cv-contact").animate({left:"0"},300):t(".cv-contact").animate({left:"-320px"},300)}))}function l(){t("#print").click(function(e){e.preventDefault(),t(".no-print").hide(),window.print()})}t(document).ready(function(){e(),n(),i(),c(),o(),l()}),t(window).scroll(function(){a(),c()}),t(window).resize(function(){})}(window.jQuery);
